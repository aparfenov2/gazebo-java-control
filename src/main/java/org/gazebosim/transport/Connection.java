...
//      host = ssocket.getInetAddress().getHostAddress(); // TODO: get globally addressable name.
        ...
        startNewListeningThread(cb);
	}

    public void serve(String ahost, int aport, final ServerCallback cb) throws IOException {
        host = ahost;
        port = aport;
    ...
    private void startNewListeningThread(final ServerCallback cb) {
